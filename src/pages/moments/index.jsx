    ...
    return (
        <>
            ...
            <section className='flex bg-black' data-scroll-section>
                <Header imageUrl={headerImage} type="image" title={t('moments.header')} imagePos='bg-right-top' subTitle={t('moments.subCopy')} preTitle={t('moments.preTitle') !== 'moments.preTitle' ? t('moments.preTitle') : ''} />
            </section>  
