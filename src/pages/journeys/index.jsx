    ...
    return (
        <>
            ...
            <section className='flex bg-black' data-scroll-section>
                <Header imageUrl={headerImage} type="image" title={t('journeys.header')} subTitle={t('journeys.subCopy')} preTitle={t('journeys.preTitle') !== 'journeys.preTitle' ? t('journeys.preTitle') : ''} />
            </section>  
            <section className='bg-black'  data-scroll-section>
                <div className="container md:m-auto mx-10 relative py-16">                    
                    <div className="grid grid-cols-1">
                        <div>
                            <h2 className='text-2xl text-left tracking-custom leading-10 text-light-grey'>JUMP TO</h2>
                        </div>
                        <div className='mt-8'>
                            <PrivilegeButtonList pageName='journeys' goToPrivilege={goToPrivilege} />  
                        </div>
                    </div>
                </div>  
            </section>
            <section className='bg-black'  data-scroll-section>
                <PrivilegeList pageName='journeys' scrollToTop={scrollToTop} />                 
            </section> 
